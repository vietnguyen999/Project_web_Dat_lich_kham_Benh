       ...
       <div className="header-rangsu">
        ...
        <Col className='section-rangsu-left' xs={12} md={8}>
         ...
         <Col className=' section-rangsu-left-tin-left' xs={12} md={6}>
            ...
            Tẩy trắng răng là phương pháp nha khoa có tác dụng giúp loại bỏ các sắc tố vàng,
         ...
         <Col className=' section-rangsu-left-tin-left' xs={12} md={6}>
            ...
            <p className='section-rangsu-left-tin-left-p'>
            Đau nhức là những nỗi sợ của khách hàng trước mỗi ca nhổ răng! Hiểu 
         ...
         <img src={imgs29} alt='' className='section-rangsu-left-tin-left-img'/>
            ...
            <p className='section-rangsu-left-tin-left-p'>
            Viêm tủy răng là nguyên nhân phổ biến gây đau nhức và mất răng. Viêm
             tủy răng bao gồm viêm vùng tủy của răng và mô bao xu....</p>
            <button className='section-rangsu-left-tin-left-btn'>XEM CHI TIẾT...</button>
         </Col>
         </Row>
         ...
         <Col className=' section-rangsu-left-tin-left' xs={12} md={6}>
            ...
            <p className='section-rangsu-left-tin-left-p'>
            Trong trường hợp muốn phục hình nhanh tình trạng răng mẻ, vỡ, răng thưa, gãy…
         ...
         <img src={imgs31} alt='' className='section-rangsu-left-tin-left-img'/>
            ...
            <p className='section-rangsu-left-tin-left-p'>
            Cao răng khi tồn tại quá lâu có thể gây ra nhiều bệnh lý răng miệng nguy hiểm.
             Lấy cao răng là kỹ thuật đơn giản nhất để loại bỏ những mảng bám...</p>
            <button className='section-rangsu-left-tin-left-btn'>XEM CHI TIẾT...</button>
         </Col>
         </Row>
