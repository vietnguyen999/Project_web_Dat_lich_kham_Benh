          ...
          <div class="row sectiopn-information-clinic">
            <div class="col-md-3 sectiopn-information">
              ...
              <div className="text-section">
                ...
                <p className="text-section-p">
                  Đội ngũ bác sĩ là chuyên gia với nền tảng chuyên môn vững
                  chắc, giàu kinh nghiện và y đức
                </p>
              </div>
            </div>
            ...
            <div class="col-md-3 sectiopn-information">
              ...
              <div className="text-section">
                ...
                <p className="text-section-p">
                  Hệ thóng trang thiết bị hiện đại bậc nhất được nhập khẩu từ
                  các nước Hà lan,Anh, Đức, Mỹ
                </p>
              </div>
            </div>
            ...
            <div class="col-md-3 sectiopn-information">
              ...
              <div className="text-section">
                ...
                <p className="text-section-p">
                  Chi phí khám và điều trị, phẫu thuật minh bạch, rõ ràng cùng
                  nhiêu ưu đại hổ trợ hấp dẫn
                </p>
              </div>
            </div>
        ...
        <section>
          <div className="row part-news">
            ...
            <div className="col part-news-text">
              ...
              <p className="part-news-text-p">
                Với 3 trụ cột là Chính trực – Kỷ luật – Sáng tạo
              </p>
              <p className="part-news-text-p">
                TẦM NHÌN Nha khoa đến năm 2025: “Là chuỗi phòng nha khoa dẫn đầu
                Buôn Ma Thuột bởi sự phục vụ tận tâm, chuyên môn giỏi và thẩm mỹ
                cao. Bằng việc vận hành cực kỳ đơn giản với tinh thần phụng sự
                khách hàng”
              </p>
              <p className="part-news-text-p">
                Và để thực hiện tầm nhìn đến năm 2025, con người Nha giá trị cốt
                lõi: Tận tâm, trung thực , kỷ luật, máu lửa, học hỏi{" "}
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="col ">
              <div className="part-service-left">
                <img
                  src={imgs7}
                  alt="..."
                  className=" part-service-left-imgs"
                />
        ...
        <div className="row section-datlich">
          <div className="col">
            <div className="section-datlich-left">
              <h2 className="section-datlich-left-h2">
                Tư vấn khám chữa bệnh chuẩn xác, hiệu quả.
              </h2>
              <p className="section-datlich-left-p">
                Đội ngũ y bác sĩ đầu ngành và giàu kinh nghiệm mang đến cho bạn
                những lời khuyên chuẩn xác và phù hợp nhất với tình trạng mỗi cá
                nhân
              </p>
              <button className="section-datlich-left-btn">
          ...
          <div className="col">
            <div className="section-datlich-right">
              <img
                src={imgs9}
                alt="..."
                className="section-datlich-right-img"
              />
